...
namespace Salky.App.Services
{
    public partial class RsaService : IDisposable
    {
        ...
        public string Decrypt(string encryptedtext)
        {
            ...
            var decryptedData = cryptoService.Decrypt(encryptedData, RSAEncryptionPadding.OaepSHA512);
        ...
        public string Encrypt(string plainText)
        {
            ...
            var textEncryptedData = cryptoService.Encrypt(plainTextData, RSAEncryptionPadding.OaepSHA512);
